...
// Copy of CompositeStorage
public class CompositeFormStorage implements MEStorage, ITickingMonitor {
    private final InventoryCache cache;

    private Map<Byte, MEStorage> storages;

    private boolean forceCacheRebuild;

    public CompositeFormStorage(Map<Byte, MEStorage> storages) {
        this.storages = storages;
        this.cache = new InventoryCache();
    }

    public void setStorages(Map<Byte, MEStorage> storages) {
